...
export const SESSION_COOKIE_NAME = `${securePrefix}shewell-doctor.session-token`;
export const CALLBACK_COOKIE_NAME = `${securePrefix}shewell-doctor.callback-url`;
export const CSRF_COOKIE_NAME = `${hostPrefix}shewell-doctor.csrf-token`;
