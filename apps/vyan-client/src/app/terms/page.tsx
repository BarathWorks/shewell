...
const TermsPage = () => {
  return (
    <LegalPage
      ...
      subtitle="Prenatal & Postnatal Counselling Platform"
    ...
    >
      ...
      <ul className="mb-4 mt-2 list-inside list-disc space-y-1 pl-2">
      ...
      <h3 className="my-2 text-base font-semibold xl:text-lg">
      Eligibility
      </h3>
      <p className="mb-2 text-sm lg:text-base">
      ...
      <p className="mb-1 text-sm font-medium lg:text-base">
