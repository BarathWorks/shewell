...
const ClientSessionProvider = ({
  ...
  // PERFORMANCE: verifiedAt is now optional to avoid blocking DB queries in layout
  if (verifiedAt !== undefined && session && verifiedAt === null && pathname !== `/auth/register-otp`) {
