  ...
  return (
    <>
      <div className="mb-6 flex items-center gap-2">
        ...
        <span className="font-poppins text-lg font-semibold text-ink">
          Available Time Slots
        </span>
      </div>
            ...
            {days.map((day) => (
              <div
                ...
                className={`flex cursor-pointer flex-col items-center justify-center rounded-xl px-4 py-2 transition-all duration-300 ${
                  format(day, "yyyy-MM-dd") ===
                  format(selectedDate, "yyyy-MM-dd")
                    ? "border-0 bg-primary-600 text-white shadow-md"
                    : "border-0 bg-transparent text-muted hover:bg-white hover:text-primary-700"
                }`}
              >
