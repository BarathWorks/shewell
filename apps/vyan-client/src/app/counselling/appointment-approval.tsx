          ...
          badge={
            <span
              className={`rounded-full px-2.5 py-0.5 text-[10px] font-bold uppercase tracking-wider border ${
                isCouple
                  ? "bg-[#eff4ff] text-[#006879] border-[#006879]/10"
      ...
      <div className="overflow-hidden rounded-2xl border border-gray-100 bg-white shadow-sm">
          ...
          <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl bg-[#eff4ff]">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
              <rect
                ...
                strokeWidth="2"
              />
              <path d="M2 10H22" stroke="#006879" strokeWidth="2" />
            </svg>
          </div>
          <div>
        ...
        <div className="flex flex-col gap-2 px-5 py-4 font-poppins">
          ...
          <div className="flex items-center justify-between text-sm">
            ...
            <span className="font-bold text-[#006879]">
              + INR {gstAmount}
            </span>
          </div>
          <div className="mt-1 flex items-center justify-between border-t border-dashed border-gray-100 pt-3">
            ...
            <span className="text-lg font-bold text-[#006879]">
              INR {totalWithGST}
            </span>
          </div>
        </div>
        ...
        <div className="border-t border-gray-50 px-5 py-3 text-xs text-gray-400">
          ...
          <Link
            href="/terms"
            target="_blank"
            className="text-[#006879] hover:underline"
          >
            Terms and Conditions
          </Link>{" "}
          and{" "}
          <Link href="#" className="text-[#006879] hover:underline">
            Privacy Policy
          </Link>
        </div>
      </div>
