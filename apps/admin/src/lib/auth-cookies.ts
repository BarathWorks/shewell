...
export const SESSION_COOKIE_NAME = `${securePrefix}shewell-admin.session-token`;
export const CALLBACK_COOKIE_NAME = `${securePrefix}shewell-admin.callback-url`;
export const CSRF_COOKIE_NAME = `${hostPrefix}shewell-admin.csrf-token`;
